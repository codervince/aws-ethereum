...
geth --port 30301 --networkid "$NETWORK_ID" --unlock e986f163e65361be0f08aa48dcc3a7b12a57baf0 --password /home/ubuntu/account.passwd --mine --minerthreads=1 >>ethereum.log 2>&1 &
disown
sleep 5
